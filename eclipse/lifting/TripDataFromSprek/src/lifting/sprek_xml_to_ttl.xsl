...
<xsl:text disable-output-escaping="yes">	sf_ont:degree_of_difficulty			"Easy"@en ;
	sf_ont:referedBy					&lt;http://tur.bt.no&gt; ;
	
</xsl:text>
<!-- <xsl:value-of select="column[@name='difficulty']"/> (IF 1 THEN "Easy")-->
</xsl:if>
<xsl:if test="column[@name='difficulty'] = 2">
<xsl:text disable-output-escaping="yes">	sf_ont:degree_of_difficulty			"Average"@en ;
	sf_ont:referedBy					&lt;http://tur.bt.no&gt; ;
...
<xsl:text disable-output-escaping="yes">	sf_ont:degree_of_difficulty			"Hard"@en ;
	sf_ont:referedBy					&lt;http://tur.bt.no&gt; ;
...
<xsl:text disable-output-escaping="yes">	sf_ont:degree_of_difficulty			"Very hard"@en ;
	sf_ont:referedBy					&lt;http://tur.bt.no&gt; ;
...
<xsl:text disable-output-escaping="yes">	a					sf_ont:Stroller_friendly ;
...
<!-- <xsl:value-of select="column[@name='encoded_path']"/> (Replacing \ with \\ in the next line, so it will validate in Jena)-->
...
<xsl:text disable-output-escaping="yes">@prefix sf_ont: &lt;http://data.sognefjord.vestforsk.no/resource/ontology#&gt; .
@prefix dct: &lt;http://purl.org/dc/terms/&gt; .
...
<!-- <column name="ingress"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:ingress			"""</xsl:text>
<xsl:value-of select="column[@name='ingress']"/>
<xsl:text disable-output-escaping="yes">"""@no ;
</xsl:text>

<!-- <column name="description"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:description		"""</xsl:text>
<xsl:value-of select="column[@name='description']"/>
<xsl:text disable-output-escaping="yes">"""@no ;
</xsl:text>

<!-- <column name="image"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:image			&lt;http://turcache.bt.no/webroot/img/</xsl:text>
<xsl:value-of select="column[@name='image']"/>
<xsl:text disable-output-escaping="yes">&gt; ;
</xsl:text>

<!-- <column name="image_credit"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:image_credit		"""</xsl:text>
<xsl:value-of select="column[@name='image_credit']"/>
<xsl:text disable-output-escaping="yes">""" ;
</xsl:text>

<!-- <column name="created"> -->
<xsl:text disable-output-escaping="yes">	dct:created				"""</xsl:text>
<xsl:value-of select="column[@name='created']"/>
<xsl:text disable-output-escaping="yes">""" .
</xsl:text>
...
<xsl:text disable-output-escaping="yes">	sf_ont:trimtoppen_image				&lt;http://turcache.bt.no/webroot/img/</xsl:text>
<xsl:value-of select="column[@name='trimtoppen_image']"/>
<xsl:text disable-output-escaping="yes">&gt; ;
</xsl:text>

<!-- <column name="trimtoppen_description"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:trimtoppen_description		"""</xsl:text>
<xsl:value-of select="column[@name='trimtoppen_description']"/>
<xsl:text disable-output-escaping="yes">"""@no ;
</xsl:text>

<!-- <column name="trimtoppen_image_credit"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:trimtoppen_image_credit		"""</xsl:text>
...
<xsl:text disable-output-escaping="yes">	sf_ont:modified						"""</xsl:text>
...
<!-- <column name="name"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:gowalla_name					"""</xsl:text>
<xsl:value-of select="column[@name='name']"/>
<xsl:text disable-output-escaping="yes">"""@no ;
</xsl:text>

<!-- <column name="description"> -->
<xsl:text disable-output-escaping="yes">	sf_ont:gowalla_description			"""</xsl:text>
<xsl:value-of select="column[@name='description']"/>
<xsl:text disable-output-escaping="yes">"""@no .
</xsl:text>
...
<xsl:text disable-output-escaping="yes">&lt;</xsl:text>
<!-- <xsl:value-of select="column[@name='id']"/> -->
<xsl:call-template name="create-place-uri"><xsl:with-param name="id" select="column[@name='id']"/></xsl:call-template>
<xsl:text disable-output-escaping="yes">#&gt;
	a						owl:Individual .
	
sf_ont:place</xsl:text><xsl:value-of select="column[@name='id']"/>
<xsl:text disable-output-escaping="yes">
	sf_ml_ont:nameOf			&lt;</xsl:text>
<!-- <xsl:value-of select="column[@name='id']"/> -->
<xsl:call-template name="create-place-uri"><xsl:with-param name="id" select="column[@name='id']"/></xsl:call-template>
...
</xsl:for-each><!-- Slutt på løkke for kvar <table name="spots"> -->
</xsl:result-document>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////
########################################################################################################
	semantic.ttl - END
...
<xsl:for-each select="table[@name='spots']">
<!-- <column name="id"> -->
<xsl:text disable-output-escaping="yes">sf_ont:place</xsl:text>
<xsl:value-of select="column[@name='id']"/>
<xsl:text disable-output-escaping="yes">
	a				sf_ml_ont:Name .
</xsl:text>
