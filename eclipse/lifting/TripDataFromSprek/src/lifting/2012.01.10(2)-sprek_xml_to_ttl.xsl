<!--
	...
	Det siste som vart gjort her er at google map encoded verdien måtte bytte ut alle "/" med "//".
-->
...
<xsl:call-template name="create-hike-uri"><xsl:with-param name="id" select="current-grouping-key()"/></xsl:call-template>
<xsl:text disable-output-escaping="yes">#&gt;
</xsl:text>
<xsl:for-each select="current-group()">
<xsl:text disable-output-escaping="yes">	sf_ont:Goal					sf_ont:place</xsl:text>
...
//////////////////////////////////////////////////////////////////////////////////////////////////// -->
		...
		<xsl:message terminate="no"><xsl:value-of select="$dir_hike_documents"/>/m<xsl:value-of select="$filename"/></xsl:message>
...
########################################################################################################
//////////////////////////////////////////////////////////////////////////////////////////////////// -->
<xsl:result-document format="xml" href="{$dir_hike_documents}/m{$filename}">
...
<xsl:text disable-output-escaping="yes">
	ml:NameOf				sf_hike:</xsl:text><xsl:value-of select="column[@name='id']"/>
<xsl:text disable-output-escaping="yes"># .
